...
import { Building2, Calendar, Check, ChevronDown, ChevronUp, ChevronsUpDown, DollarSign, Hash, Home, MapPin, Shield, Zap } from 'lucide-react';
        ...
        <AppLayout breadcrumbs={getBreadcrumbs()}>
            ...
            <div className="min-h-screen bg-background">
                <div className="container mx-auto max-w-7xl space-y-6 px-4 py-8">
                    ...
                    <div className="sticky top-0 z-30 -mx-4 border-b border-gray-200/50 bg-white/95 px-4 py-2 backdrop-blur-sm supports-[backdrop-filter]:bg-white/80 dark:border-gray-800/50 dark:bg-gray-950/95 dark:supports-[backdrop-filter]:bg-gray-950/80">
